from Algebra.Structures.Matrix.MatrixProperties.DefinitenessProperty import DefinitenessProperty
...
definiteness = DefinitenessProperty()
orthogonality = Orthogonality()
symmetrical = SymmetricProperty()
